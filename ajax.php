<?php 
	...
	switch ($action) {
		...
		case 'LOADCART':
			...
			//	$cliente['celular']    = $_POST['celular_val'];
				...
				//$celular_cliente		 = $cart_detalle['cliente']['celular'];
...
///555
			...
			/* 	$html_email = '	<div class="text-center">
					...
					<div class="container">
						...
						<span class="d-block">Celular: '. $cart_detalle['cliente']['celular'] .'</span>
 ...
 */
				// Send mail
				//send_email('rmipialesg@utn.edu.ec', $asunto = 'Detalle pedido' , $html_email);
