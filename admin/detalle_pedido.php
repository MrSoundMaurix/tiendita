<?php 
	...
	$pedidos = get_all_detalles_total();
...
<div class="container">
    ...
    <ul class="navbar-nav">
		<li class="nav-item"><span class="nav-link"> Cel: 0959072238</span></li>
	</ul>
</nav>
...
<div class="row">
	<aside class="col-md-3">
		<ul class="list-group">
			...
			<a class="list-group-item active" href="admin/detalle_pedido.php"> Detalle de pedidos </a>
		</ul>
	</aside> <!-- col.// -->
	<main class="col-md-9">
		...
		<?php if(!empty($pedidos)): ?>
			<table class="table table-sm">
				...
				<?php foreach($pedidos as $pedido): ?>
					<tr>
						<td><?php echo $pedido['id_detalle']; ?></td>
		...
		<?php else: ?>
			<div class="">
				<h2 class="text-center mt-5">No hay pedidos en la lista</h2> <br><br>
			</div>
		<?php endif; ?>
		</article>
	</main>
...
<footer class="section-footer border-top bg fixed-bottom">
	<div class="container">
		<section class="footer-bottom row">
			<div class="col-md-12">
				<p class="text-muted text-center"> &copy <?php echo date('Y'); ?> - MrSoundMaurix </p>
			</div>
		</section>
	</div>
</footer>
